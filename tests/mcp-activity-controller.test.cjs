...
const activityApi = require("../app/src/integrations/mcp-activity.js");
const { createMcpActivityController } = require("../app/src/integrations/mcp-activity-controller.js");
